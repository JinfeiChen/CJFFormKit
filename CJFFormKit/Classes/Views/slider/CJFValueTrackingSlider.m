//
//  CJFValueTrackingSlider.m
//  Pods
//
//  Created by cjf on 10/12/2020.
//

#import "CJFValueTrackingSlider.h"
#import "CJFValuePopUpView.h"

@interface CJFValueTrackingSlider ()<CJFValuePopUpViewDelegate>

@property (nonatomic, strong) NSNumberFormatter * numberFormatter;
@property (nonatomic, strong) CJFValuePopUpView * popUpView;

@end

@implementation CJFValueTrackingSlider
{
...
- (void)setup {
    ...
    self.popUpView = [[CJFValuePopUpView alloc] initWithFrame:CGRectZero];
