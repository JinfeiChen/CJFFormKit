...
//@property (assign, nonatomic) BOOL allowPickingVideo; /**< 是否允许选择视频 默认 NO */
@property (assign, nonatomic) BOOL allowPickingImage; /**< 是否允许选择图片 默认 YES */
@property (assign, nonatomic) BOOL allowPickingGif; /**< 是否允许选择动图 默认 NO */
...
//@property (assign, nonatomic) BOOL showTakeVideoBtn; /**< 是否允许拍视频 默认 NO */
