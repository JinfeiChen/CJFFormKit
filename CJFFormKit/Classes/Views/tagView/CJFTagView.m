...
#import "CJFTagView.h"
#import <CJFFormKit/CJFTagFrame.h>

@implementation CJFTagViewUIModel
...
- (void)setDataUIModelArray:(NSArray<CJFTagViewUIModel *> *)dataUIModelArray {
    ...
    for (CJFTagViewUIModel *UIModel in dataUIModelArray) {
    ...
    [dataUIModelArray enumerateObjectsUsingBlock:^(CJFTagViewUIModel * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
